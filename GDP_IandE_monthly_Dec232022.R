...
# November 29, 2022; December 6, 2022; December 23, 2022
...
# Qdata      - All the quarterly SAAR data at current prices for I&E-based GDP
...
saveRDS(Edata,paste0("/Users/philipsmith/Documents/R/GDP/GDP_IandE_monthly/",
  "GDP_results.rds")) 
...
if (lastmonF>lastmon) {
  ...
  View(REGRES)
  saveRDS(REGRES,"ARIMA_REGRES.rds")
...
if (lastmonF>lastmon) {
  ...
  View(REGRES)
  saveRDS(REGRES,"ARIMA__ByDeflation_REGRES.rds")
...
#EQUALcases <- list()
#for (i in 1:N) {
#  if (GDP[[i]]$type=="Equality") {
#    EQUALcases <- c(EQUALcases,GDP[i])
#  }
#}
...
REGRESpub$SEE <- round(REGRESpub$SEE,3)
View(REGRESpub)
saveRDS(REGRES,"KREGRES.rds")
saveRDS(REGRESpub,"KREGRESpub.rds")
#-------------------------------------------------------------------------------
# Calculate the identity cases using the identity equations
IdentCases <- character()
Idents <- character()
...
saveRDS(Edata, "GDP_C_monthly_2012_doneDec232022to102022.rds")
saveRDS(IDdata,"GDP_K_monthly_2012_doneDec232022to102022.rds")
saveRDS(IPdata,"GDP_P_monthly_2012_doneDec232022to102022.rds")
